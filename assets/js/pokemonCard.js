...
async function getPokeDetail() {
  ...
  const divGeral = document.getElementById("cardInfo");

  const sectionGeral = document.createElement("section");
  sectionGeral.setAttribute("id", "detail_pokemon_card");
  sectionGeral.classList.add("detail_pokemon_card");
  sectionGeral.classList.add(`${data.types[0].type.name}`);

  const div1 = document.createElement("div");
  div1.setAttribute("id", "divDetalhe");
  ...
  span2.classList.add("card-number");
